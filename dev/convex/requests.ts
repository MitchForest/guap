...
import { RequestKindSchema, RequestStateSchema, RequestKindValues, RequestStateValues } from '@guap/types';
import { literalEnum } from './utils';

const now = () => Date.now();

const requestKindArg = literalEnum(RequestKindValues);

const requestStateArg = literalEnum(RequestStateValues);
