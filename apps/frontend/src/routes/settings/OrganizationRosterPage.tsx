    ...
    <div class="space-y-8">
      <header class="space-y-2">
        ...
        <p class="text-sm text-slate-600">
          Manage who can access this program. Seats are billed per member; admins are included for free.
        </p>
      </header>
      ...
      <Show when={organizationId()} fallback={<p class="text-sm text-slate-500">Link this account to an organization to manage bulk seats.</p>}>
        ...
        <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <Show
            when={canManage()}
            fallback={<p class="mt-3 text-sm text-slate-500">Only owners and admins can invite members.</p>}
          >
